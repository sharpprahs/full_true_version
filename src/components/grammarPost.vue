<template>
  <div class="container_accesses_users animation_top">
    <div class="nav_panel">
      <div class="access_title">Граматика публикации</div>
    </div>
    <div class="conatainer_type_content">
      <a href="#" class="types_content active">Все</a>
      <a href="#" class="types_content">Elementary</a>
      <a href="#" class="types_content">Pre-Intermediate</a>
      <a href="#" class="types_content">Intermeadiate</a>
    </div>
    <div class="table_container">
      <UTable :headers="headers" :data="data">
        <template #column0="{ entity }">
          <a :href="entity.number_link">{{ entity.number }}</a>
        </template>
      ...
      data: [
        {
          number: "1",
          number_link: "#",
          title: "Bucket list: what is it and why do you need it?",
          title_link: "#",
          date: "27 апреля в 14:23",
          date_link: "#",
          file: "https://api.mave.digital/storage/podcasts/0b7f47cd-3813-4e55-b32e-fbdf92f13643/episodes/5d6589da-1b51-4c7f-a69c-c99b0dfb7dc6.mp3",
          file_link: "#",
        },
      ],
      slider_value: "",
