...
class TeacherCertificateTypeTableSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        DB::table('teachercertificatetype')->delete();

        // Путь к SQL-файлу с данными
        $sqlFilePath = database_path('migrations/teachercertificatetype.sql');
